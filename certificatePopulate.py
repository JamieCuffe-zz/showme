# Generated by Django 2.0.4 on 2018-04-12 03:55
import json
    ...
    for i in range(len(requirements)):
        ...
        if 'course_list' in requirements[i]:
            ...
            for course in range(len(requirements[i]['course_list'])):
                trackInfo['courses'].append(requirements[i]['course_list'][course].split(':')[0].replace('*', 'X'))
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('hello', '0006_delete_certificates'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tracks', models.CharField(max_length=100000)),
            ],
            options={
