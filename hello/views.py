...
def certificate(request):
    ...
    if request.method == 'GET':
        ...
        for i in range(0, len(totalOutput)):
            ...
            for j in range(0, len(totalOutput[i]["req_list"])):
                totalOutput[i]["req_list"][j]["barGraph"] = [colors[j%5], totalOutput[i]["req_list"][j]["count"], totalOutput[i]["req_list"][j]["min_needed"], totalOutput[i]["req_list"][j]["count"]/totalOutput[i]["req_list"][j]["min_needed"] * 100]
